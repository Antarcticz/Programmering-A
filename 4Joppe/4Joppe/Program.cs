...
namespace _4Joppe
{
    ...
    class Petowner
    {
        ...
        private int currency = 150;   // Petowner starts with these coins

        private int max_pet_nr = -1;  // Sätts till antal djur -1 i Start_UP() så att Fetch_Animal() fungerar
        private int pet_nr = -1;      // Håller reda på vilket djur som är valt. -1 gör att Fetch_Animal() loopen loopar tills man skriver in ett djur som finns.
        private int ball_nr = -1;     // Håller reda på vilken boll som är vald. -"-
                        ...
                        if (ball_nr != -1)  // Om du har en boll så kan du hemta ett djur och böja fighten
                        {
                            ...
                            if (ball_list[ball_nr].Check_Durability() <= 0)  // Om bollen går sönder så får Petowner (c) och den trasiga bollen tas bort från listan
                            {
                                ...
                                if (ball_list[ball_nr].Check_Ball_Name() == "Small Ball ")
                                {
                                    ...
                                    Console.WriteLine("Congratulations! You have earned 100(c)");
                                }
        ...
        public void Game_Over()
        {
            ...
            Console.WriteLine("|                                           X           It's           X                                              |");
            Console.WriteLine("|         All Animals Are Hungry            X    =    Game Over   =    X              Your Out Of Coins               |");
            Console.WriteLine("|                                           X            If            X                                              |");
            Console.WriteLine("|                                           XXXXXXXXXXXXXXXXXXXXXXXXXXXX                                              |");
        }
        ...
        public void Start_Up()
        {
            ...
            {                                  // Lägger man till ny matsort så måste man bygga ut i Feed_Animal()
                Add_Dog(  0, 8, 200, "Dog", "Bosse  ", "Boxer          ", "Hamburger  ", false, "Woff, woff!!   ");
                Add_Dog(  1, 6, 200, "Dog", "Daicy  ", "Golden Retriver", "Sausage    ", false, "Woffeli, woff!!");
                Add_Puppy(2, 0, 150, "Dog", "Essob  ", "Boxer          ", "Meatballs  ", false, "Beep, beep!!   ", 6);
                Add_Puppy(3, 0, 150, "Dog", "Gunilla", "Tax            ", "Dog Biscuit", false, "Yelp, yelp!!   ", 9);
                Add_Cat(  4, 9, 100, "Cat", "Maja   ", "Tortoiseshell  ", "Tuna       ", false,  0);
                Add_Cat(  5, 2, 100, "Cat", "Oskar  ", "Moggie         ", "Meatballs  ", false,  0);
        ...
        public void List_Animal()
        {
            ...
            foreach (var i in pet_list)
            {
                i.PrintDetails();  // Print Method from class
            }
            Console.WriteLine("");
            Console.WriteLine("=======================================================================================================================");
            Console.WriteLine("");
        ...
        public void Feed_Animal()
        {
            ...
            else
            {
                ...
                foreach (var i in pet_list)
                {
                    i.Eat(food_given);  // Jämför food_given med fav_food, om lika så blir djuret mätt
                    i.Hungry_Animal();
                }
            }
            Console.WriteLine("");
        ...
        public void Fetch_Animal()
        {
            ...
            foreach (var i in pet_list)
            {
                Console.WriteLine(i);  // Prints the ToString()
            }
            ...
            } while (pet_nr < 0 || pet_nr > max_pet_nr);  // Om man lägger till fler djur i listan så måste man ändra här också  
            Console.WriteLine("");                        // Fetch_Animal() kan bara brytas om man väljer ett djur som finns
        ...
        {
            int max_ball_nr = -1;      // Håller reda på hur många bollar man har köpt, om man inte har köpt några bollar så kommer 
                                       // max_ball_nr vara = -1 efter foreach loopen, så man kan söka på bollarna i boll listan
        ...
        public void Ball_Shop()
        {
            ...
            do
            {
                ...
                {
                    Console.WriteLine("");
                    Console.WriteLine("Your need at least 50(c) to shop");
                    int_alt = 4;
                }
                ...
                else
                {
                    try
                    {
                        ...
                        Console.WriteLine("-----------------------------------------------------------------------------------------------------------------------");
                        Console.WriteLine("");
                        Console.WriteLine("What ball do you want to buy? [1]Small 50(c) | [2]Medium 100(c) | [3]Large 300(c) | [4]Exit Ball Shop");
                        int_alt = int.Parse(Console.ReadLine());
                    }
                    catch (System.FormatException e)
                    {
                ...
                switch (int_alt)        // Reward S: 100(c)  M: 200(c)  L: 600(c)
                {
                    case 1:
                        Console.WriteLine(" ");
                        Console.WriteLine("You choose: Small Ball");
                        Add_Ball(100, "White ", "Small Ball ");
                        currency = currency - 50;
                        break;

                    case 2:
                        Console.WriteLine(" ");
                        Console.WriteLine("You choose: Medium Ball");
                        if (currency < 100)
                        {
                    ...
                    case 3:
                        Console.WriteLine(" ");
                        Console.WriteLine("You choose: Large Ball");
                        if (currency < 300)
                        {
                    ...
                    case 4:
                        Console.WriteLine(" ");
                        Console.WriteLine("Exit Ball Shop");
                        Console.WriteLine(" ");
                        avbryt_nr = 4;
                        break;
    ...
    public abstract class Animal // ParentClass for Cat and Dog
    {
        ...
        /*-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                                                                               METHOD  INTERACT
          -------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        public virtual void Interact(Ball _ball)  // Metod anrop från Play_Game() pet_list[pet_nr].Interact(ball_list[ball_nr]);
        {
            ...
            do
            {
                ...
                else
                {
                    ...
                    if (check < 66)
                    {                   // Bollen har 65% chans att ta skada
    ...
    public class Cat : Animal  // ChildClass to Animal
    {
        ...
        public Cat(int id_nr, int age, int hp, string type, string name, string breed, string fav_food, bool hungry) : base(id_nr, age, hp, type, name, breed, fav_food, hungry) 
        {
        }
        ...
        public override void Hungry_Animal()
        {
            ...
            if (hungry == true)       // Om Cat och är hungrig, så går den på mus jakt
            {
                ...
                if (hunt_skill == 0)
                {
                    if (check2 < 51)  // Cat fånger en mus med 50% chans, den blir mätt och hunt_skill blir lvl 1
                    {
                        hungry = false;
                        hp = hp + 5;  // Hp stiger varje gång djuret äter
                ...
                {
                    if (check2 < 61)  // Cat fångar en mus med 60% chans, den blir mätt och hunt_skill blir lvl 2
                    {
                        hungry = false;
                        hp = hp + 5;  // Hp stiger varje gång djuret äter
                        hunt_skill = hunt_skill + 1;
                ...
                {
                    if (check2 < 71)  // Cat fångar en mus med 70% chans, den blir mätt och hunt_skill blir lvl 3
                    {
                        hungry = false;
                        hp = hp + 5;  // Hp stiger varje gång djuret äter
                        hunt_skill = hunt_skill + 1;
                ...
                {
                    if (check2 < 81)  // Cat fångar en mus med 80% chans, den blir mätt och hunt_skill blir lvl 4
                    {
                        hungry = false;
                        hp = hp + 5;  // Hp stiger varje gång djuret äter
                        hunt_skill = hunt_skill + 1;
                ...
                {
                    if (check2 < 91)  // Cat fångar en mus med 90% chans, den blir mätt och hunt_skill blir lvl 5
                    {
                        hungry = false;
                        hp = hp + 5;  // Hp stiger varje gång djuret äter
                        hunt_skill = hunt_skill + 1;
                ...
                {
                    if (check2 < 101)  // Cat fångar en mus med 100% chans, den blir mätt och hunt_skill är max lvl
                    {
                        hungry = false;
                        hp = hp + 5;  // Hp stiger varje gång djuret äter
                        Console.WriteLine("It cought a mouse and is now fed :)");
    ...
    public class Dog : Animal  // ChildClass to Animal
    {
        ...
        /*-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                                                                               METHOD  INTERACT
          -------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        public override void Interact(Ball _ball)  // Metod anrop från Play_Game() pet_list[pet_nr].Interact(ball_list[ball_nr]);
        {
        ...
        public override void Interact(Ball _ball)  // Metod anrop från Play_Game() pet_list[pet_nr].Interact(ball_list[ball_nr]);
        {
            ...
            do
            {
                ...
                else
                {
                    ...
                    {                   // Bollen har 65% chans att ta skada
                        _ball.Lower_Durability();
                        _ball.Lower_Durability();  // Durability 2x för Puppy
                        Console.WriteLine("Ball Damage Taken!");
                        Console.WriteLine("");
                    }
