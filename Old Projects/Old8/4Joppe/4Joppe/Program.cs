...
namespace _4Joppe
{
    ...
    class Petowner
    {
        ...
        public int currency = 150;   // Petowner starts with these coins

        public int max_pet_nr = -1;  // Sätts till antal djur -1 i Start_UP() så att Fetch_Animal() fungerar
        public int pet_nr = -1;      // Håller reda på vilket djur som är valt. -1 gör att Fetch_Animal() loopen loopar tills man skriver in ett djur som finns.
