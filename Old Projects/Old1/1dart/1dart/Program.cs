...
namespace _1dart
{
    ...
    class Game
    {
        ...
        public void Play_Game()
        {
            ...
            //Console.WriteLine(player_list[0]);
            //Console.WriteLine(player_list[1]);
    ...
    class Turn  
    {
        ...
        public override string ToString()
        {
            return string.Format("Points for dart1: {0}, points for dart2: {1} & points for dart3: {2}", dart1, dart2, dart3);
        }
    }
}
