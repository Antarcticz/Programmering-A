...
namespace _4Joppe
{
    ...
    class Petowner
    {
        ...
        public void Play()
        {
            Fetch_Animal();
            Fetch_Ball();
            Console.WriteLine("Playing with {0}", pet_list);
        }
        ...
        public void Fetch_Animal()
        {
            ...
            int int_nr = 99;  // Måste förmodligen lägga den som public högst upp i Petowner, samma för bollen
            do
            {
                try
                {
            ...
            } while (int_nr < 0 || int_nr > 4);  // Om man lägger till fler djur i listan så måste man ändra här också  // Fetch_Animal kan bara brytas om man väljer ett djur som finns
            Console.WriteLine("Animal ID nr {0} is selected", pet_list[int_nr]);  // ID nr är indentiskt med ordningen i listan
            Console.WriteLine("");
            Console.WriteLine("=======================================================================================================================");
        }
        ...
        public void Fetch_Ball()
        {
            ...
            else
            {
                ...
                } while (int_nr < 0 || int_nr > max_ball_nr);  // Man kan inte bryta detta om man inte väljer en boll som finns
                Console.WriteLine("{0} is selected", ball_list[int_nr]);  // ID nr är indentiskt med ordningen i listan
            }
            Console.WriteLine("");
            Console.WriteLine("=======================================================================================================================");
        }
